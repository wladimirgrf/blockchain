...
//	}
    ...
    public static JsonObject getAddress (String address, FilterType filter, Integer limit, Integer offset) {
    		Map<String, String> params = new HashMap<String, String>();
        ...
        String uri = String.format("rawaddr/%s", address);
        return Service.get(uri, params);
    }

    public static JsonObject getAddress (String address) {
